        ...
        <div class="col-sm-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="stretched-link" href="../cadastro_pessoa/index.php?opcao=medico"></a>
                </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="stretched-link" href="../cadastro_pessoa/index.php?opcao=paciente"></a>
                </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="stretched-link" href="../cadastro_pessoa/index.php?opcao=laboratorio"></a>
                </div>
            </div>
        </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="stretched-link" href="../visualizacao_pessoa/index.php"></a>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="stretched-link" href="../estatisticas/index.php"></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="stretched-link" href="../historico/_visualizacao.php?opcao=consulta"></a>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="stretched-link" href="../historico/_visualizacao.php?opcao=exame"></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="stretched-link" href="../consulta/index.php"></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="stretched-link" href="../cadastro_pessoa/_cadastro.php"></a>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="stretched-link" href="../exame/index.php"></a>
                </div>
            </div>
        </div>
    </div>

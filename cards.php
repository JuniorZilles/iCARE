        ...
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="stretched-link" href="cadastro_medico.php"></a>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="stretched-link" href="cadastro_paciente.php"></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="stretched-link" href="cadastro_laboratorio.php"></a>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
